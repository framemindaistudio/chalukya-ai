...
const CACHE = 'chalukya-v4'
const PRECACHE = ['/', '/manifest.webmanifest', '/img/brand/icon-192.png', '/img/brand/favicon-32.png', '/models/sculpture.onnx', '/models/sculpture_labels.json',
